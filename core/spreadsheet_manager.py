...
class SpreadsheetManager:
    ...
    async def _create_initial_files(self):
        ...
        csv_headers = [
            ...
            'FundamentalScore', 'Status', 'CreatedTime', 'LastUpdate'
        ]
    ...
    async def _create_excel_template(self):
        ...
        try:
            ...
            # Headers
            headers = [
                'ID', 'Symbol', 'Signal', 'Strength', 'Entry Price', 'Stop Loss', 'Take Profit',
                'Confidence', 'Risk/Reward', 'Position Size %', 'Max Risk %', 'Timeframe',
                'Timestamp', 'Expiry Time', 'Market Condition', 'Technical Confluence',
                'Fundamental Score', 'Status', 'Created Time', 'Last Update'
            ]
            ...
            # Set column widths
            column_widths = [8, 10, 8, 10, 12, 12, 12, 12, 12, 12, 10, 10, 18, 18, 15, 12, 12, 10, 18, 18]
            for col, width in enumerate(column_widths, 1):
                ws_signals.column_dimensions[openpyxl.utils.get_column_letter(col)].width = width
            ...
            perf_headers = ['Symbol', 'Total Signals', 'Win Rate %', 'Avg Confidence', 'Avg Risk/Reward', 'Last Signal']
            ...
            ws_summary.cell(row=1, column=1, value="GenX FX Trading Signals").font = Font(size=16, bold=True)
    ...
    async def _update_performance_sheet(self, workbook):
        ...
        try:
            ...
            for signal in self.signal_history:
                ...
                if not symbol_stats[symbol]['last_signal'] or signal_time > symbol_stats[symbol]['last_signal']:
    ...
    async def _update_mt4_mt5_files(self):
        ...
        try:
            ...
            with open(self.mt4_file, 'w', newline='') as f:
                ...
                headers = ['Magic', 'Symbol', 'Signal', 'EntryPrice', 'StopLoss', 'TakeProfit', 'LotSize', 'Timestamp']
                writer.writerow(headers)
            ...
            with open(self.mt5_file, 'w', newline='') as f:
                ...
                headers = [
                    'Magic', 'Symbol', 'Signal', 'EntryPrice', 'StopLoss', 'TakeProfit',
